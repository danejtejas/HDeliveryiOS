...
//    @Binding var tripData : TripHistory?
    ...
    var body: some View {
        ...
        .overlay {
            ...
            if viewModel.isGotDistance {
                ShowDistanceView(isPresented: $viewModel.isGotDistance, totalDistance: viewModel.totalDistance) {
                    Task {
    ...
    private func arrivedAction() {
        ...
        Task{
            ...
            case .inProgress:
//                await viewModel.endTripArrivedB(viewModel.tripData?.id ?? "") // G
                await viewModel.getDistance(viewModel.tripData?.id ?? "")
            case .startTask:
